...
// MFC-Pathtracing-Visualization.cpp: Definiert das Klassenverhalten für die Anwendung.
//
...
BEGIN_MESSAGE_MAP(CMFCPathtracingVisualizationApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CMFCPathtracingVisualizationApp-Erstellung

CMFCPathtracingVisualizationApp::CMFCPathtracingVisualizationApp()
{
...
// Das einzige CMFCPathtracingVisualizationApp-Objekt

CMFCPathtracingVisualizationApp theApp;


// CMFCPathtracingVisualizationApp-Initialisierung

BOOL CMFCPathtracingVisualizationApp::InitInstance()
{
	...
	CMFCPathtracingVisualizationDlg dlg;
	m_pMainWnd = &dlg;
